...
def main():
    ...
    if args.stage in ('all','test'):
        import unittest
        result=unittest.TextTestRunner(verbosity=2).run(unittest.defaultTestLoader.discover(str(c.ROOT/'tests/data_generation/stage/initial_bathymetry'),top_level_dir=str(c.ROOT)))
