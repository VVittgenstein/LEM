...
def seal_manifest(output):
    ...
    upstream=next(p for p in Path(__file__).resolve().parents if (p / 'pyproject.toml').is_file() and (p / 'AGENTS.md').is_file())/f'references/2026-09-10-platform-shape-methods/world-orogen/{commit}'
