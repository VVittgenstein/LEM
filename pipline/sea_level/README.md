...
```text
F:\LEM\datasets\2026-09-08-q1-data\A\miller2020-smoothed.tab
F:\LEM\datasets\2026-09-08-q1-data\A\miller2020-unsmoothed.tab
F:\LEM\datasets\2026-09-08-q1-data\A\spratt2016-noaa.txt
```
...
```powershell
& F:\LEM\pipline\sea_level\run.ps1
```
