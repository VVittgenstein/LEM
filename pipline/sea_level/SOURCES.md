...
- 发布日期：2020-09-28。
- 许可：CC BY 4.0，见发布页。
- 原文件：`F:\LEM\datasets\2026-09-08-q1-data\A\miller2020-smoothed.tab`。
...
- 发布日期：2020-09-28。
- 许可：CC BY 4.0，见发布页。
- 原文件：`F:\LEM\datasets\2026-09-08-q1-data\A\miller2020-unsmoothed.tab`。
...
- 原文件：`F:\LEM\datasets\2026-09-08-q1-data\A\spratt2016-noaa.txt`。
