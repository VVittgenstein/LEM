...
import numpy as np
from sea_curve import CODE,OUTPUT,VERSION,MAX_AGE,KEYS,SeaLevelCurve,write_json,read_json,file_hash
...
def main():
    ...
    result=unittest.TextTestRunner(verbosity=2).run(unittest.defaultTestLoader.discover(str(CODE/'tests')))
