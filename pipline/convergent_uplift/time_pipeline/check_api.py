...
def main():
    ...
    save(CHECKS/'api.json',dict(passed=True,shape=list(modern.shape),modern_export_error_m_yr=error,first_belt_export_error_m_yr=first_error,complete_belt_export_error_m_yr=native_error,
