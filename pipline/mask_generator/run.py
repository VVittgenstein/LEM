...
def arguments():
    ...
    parser.add_argument("--output", type=Path, default=CODE.parents[1] / "output/mask_generator")
...
def run_tests(output: Path) -> dict:
    ...
    suite = unittest.defaultTestLoader.discover(str(CODE / "tests"), pattern="test_*.py", top_level_dir=str(CODE))
