...
def main():
    ...
    p.add_argument("--results-dir", default=str((next(p for p in Path(__file__).resolve().parents if (p / 'pyproject.toml').is_file() and (p / 'AGENTS.md').is_file())) / "bench/results" / "L1"))
