...
Run: PYTHONPATH=src lem-env/python.exe scripts/pipeline_scan_summary.py --root output/dev/scan_f05 --configs nosink,sink --out docs/work/2026-09-09-pipeline/scan-f05.md
"""
