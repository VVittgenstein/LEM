...
class LegendWidget(QWidget):
    ...
    def __init__(self, scale: BandedScale, transform: str, units: str, title: str,
        ...
        label_width=max(metrics.horizontalAdvance(label) for label in self.edge_labels())
        self.setFixedWidth(max(8+metrics.horizontalAdvance(title),4+self.SWATCH_W+6+label_width+8))
