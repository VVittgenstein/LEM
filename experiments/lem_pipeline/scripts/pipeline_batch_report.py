"""Summarize a generated batch (output of experiments/lem_pipeline/scripts/pipeline_generate.py) as a markdown table plus aggregate facts.

Run: PYTHONPATH=experiments lem-env/python.exe experiments/lem_pipeline/scripts/pipeline_batch_report.py --batch output/batch-test --out docs/work/2026-09-09-pipeline/batch-test.md
"""
