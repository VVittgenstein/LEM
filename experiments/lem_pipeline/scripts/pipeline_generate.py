...
Examples (lem-env interpreter, repository root):
  PYTHONPATH=experiments lem-env/python.exe experiments/lem_pipeline/scripts/pipeline_generate.py --n 8 --out output/batch-test --workers 8 --dt 10000
  PYTHONPATH=experiments lem-env/python.exe experiments/lem_pipeline/scripts/pipeline_generate.py --n 64 --seed0 1000 --out output/batch-examples --workers 8
"""
